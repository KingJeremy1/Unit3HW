...
void Bank::add_new_client() {
    Client new_client;
    //Get input from the user
    cout << "Enter client name (with '_' between first and last name): ";
    cin.ignore();
    ...
    cin >> new_client.bank_account_number;

    cout << "Enter Balance: ";
    cin >> new_client.balance;


    // Now we create a new array with one extra space for the new client
